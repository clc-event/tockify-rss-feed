    ...
    <html>
      <head>
        ...
        <style>
          ...
          h1{color:#246650;margin-bottom:4px;}
          .subtitle{color:#666;margin-top:0;margin-bottom:16px;}
          .subscribe{display:inline-block;margin-bottom:24px;background:#246650;color:#fff;padding:8px 14px;border-radius:20px;text-decoration:none;font-size:14px;font-weight:600;}
